...
the contest image for the ICPC Regional in Tehran, Iran.
...
To modify *an already installed OS* to the ICPC contest image (I don't think you're supposed to do this), follow the instructions below:
